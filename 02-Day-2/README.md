...
I changed the deployment region to Sweden Central and the VM then deployed successfully.
...
The Azure credit is active, which means the Azure side of the lab is operational.
